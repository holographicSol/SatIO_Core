/*
    ...
    catalog object type has a distinct sci-fi HUD-style marker glyph on the
    celestial sphere (see UnidentifiedStudios_CelestialSphere.cpp) instead
    of a plain dot: rings, radiating spokes, corner brackets, phyllotaxis
