...
extern "C" void app_main(void)
{
     ...
     * @note This is called after settings have been loaded, so that we can write
     * the settings to the devices before querying the devices to ensure they are
     * setup correctly.
     */
    GPIOPE_Setup_Devices();
