...
typedef enum {
    ...
    SYSTEM_FILE_PWRCFG_SIDEREAL_PREDICT,
...
static const char * getSystemTag(int t) {
    switch (t) {
        ...
        case SYSTEM_FILE_PWRCFG_SIDEREAL_PREDICT:        return "PWRCFG_SIDEREAL_PREDICT";
...
bool saveSystemFile(const char *filepath) {
    ...
    WRITE_UINT32_TAG(SYSTEM_FILE_PWRCFG_SIDEREAL_PREDICT, pwrConfigCurrent.TASK_MAX_FREQ_SIDEREAL_PREDICT);
...
bool loadSystemFile(const char *filepath) {
    ...
    while (fgets(lineBuffer, sizeof(lineBuffer), f) != NULL) {
        ...
        READ_UINT32_TAG(SYSTEM_FILE_PWRCFG_SIDEREAL_PREDICT, pwrConfigCurrent.TASK_MAX_FREQ_SIDEREAL_PREDICT);
