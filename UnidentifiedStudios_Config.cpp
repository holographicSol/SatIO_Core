...
PwrConfig pwrConfigLowPower = {
    ...
    .TASK_MAX_FREQ_TRACKPLANETS = TASK_MAX_FREQ_LOW_TRACKPLANETS,
    .TASK_MAX_FREQ_STARNAV = TASK_MAX_FREQ_LOW_STARNAV,
    .TASK_MAX_FREQ_SIDEREAL_PREDICT = TASK_MAX_FREQ_LOW_SIDEREAL_PREDICT,
...
PwrConfig pwrConfigBalanced = {
    ...
    .TASK_MAX_FREQ_TRACKPLANETS = TASK_MAX_FREQ_BALANCED_TRACKPLANETS,
    .TASK_MAX_FREQ_STARNAV = TASK_MAX_FREQ_BALANCED_STARNAV,
    .TASK_MAX_FREQ_METEORS = TASK_MAX_FREQ_BALANCED_METEORS,
    .TASK_MAX_FREQ_SIDEREAL_PREDICT = TASK_MAX_FREQ_BALANCED_SIDEREAL_PREDICT,
...
PwrConfig pwrConfigUltimatePerformance = {
    ...
    .TASK_MAX_FREQ_TRACKPLANETS = TASK_MAX_FREQ_HIGH_TRACKPLANETS,
    .TASK_MAX_FREQ_STARNAV = TASK_MAX_FREQ_HIGH_STARNAV,
    .TASK_MAX_FREQ_METEORS = TASK_MAX_FREQ_HIGH_METEORS,
    .TASK_MAX_FREQ_SIDEREAL_PREDICT = TASK_MAX_FREQ_HIGH_SIDEREAL_PREDICT,
