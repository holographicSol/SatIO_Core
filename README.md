...
**Gyroscopic Ra Dec** can be used for pointing the gyro anywhere in the Celestial Sphere and know +- where exactly that is, in Right Ascension, Declination and Altitude and Azimuth. Altitude degrees +90 should always be facing away from earth, while -90 degrees Altitude, is always the way back home.
