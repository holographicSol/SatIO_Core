 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --no-compress --stride 1 --align 1 --font unscii-8.ttf --range 32-126,176 --format lvgl -o font_unscii_12.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_unscii_12 = {
#else
lv_font_t font_unscii_12 = {
#endif
